...
$(function() {
    ...
    $('#btnCreate').click(function() {
    	top.$.jBox.open("iframe:/jeesite/a/sys/user/demo", "新增", 800, 500, {buttons:{"关闭":true}});
    });
...
<div>	
	<div style="float:right">
	  <input id="btnQuery" class="btn btn-primary" type="submit" value="查询" onclick=""/>
	  <input id="btnCreate" class="btn btn-primary" type="submit" value="新增" onclick=""/>
	  <input id="btnModify" class="btn btn-primary" type="submit" value="修改" onclick=""/>
	  <input id="btnView" class="btn btn-primary" type="submit" value="查看" onclick=""/>
	  <input id="btnDel" class="btn btn-primary" type="submit" value="删除" onclick=""/>
	</div>
